...
import { dim1, dim2 } from './shared/BaseLayout';
import { GridBaseLayout, GridBaseLayoutConfig } from './shared/GridBaseLayout';
import { LayoutHostSink, Positions, Size } from './shared/Layout';
...
export class GridLayout extends GridBaseLayout<GridBaseLayoutConfig> {
  ...
  _getItemPosition(idx: number): Positions {
    const { rolumns, padding1, positions, itemSize1, itemSize2 } =
      this._metrics!;
    return {
      [this._positionDim]:
